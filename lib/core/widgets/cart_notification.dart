...
class _CartNotificationWidget extends StatefulWidget {
  ...
  const _CartNotificationWidget({required this.product, required this.onClose});
  @override
            ...
            child: BackdropFilter(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(20),
                  border:
                      Border.all(color: themeColor.withAlpha(100), width: 1.5),
                  boxShadow: [
                    BoxShadow(
                          ...
                          children: [
                            Row(children: [
                              const Icon(Icons.check_circle_rounded,
                                  color: VirooColors.success, size: 16),
                              const SizedBox(width: 6),
                              const Text('✅ تمت الإضافة!',
                                  style: TextStyle(
...
class _FavoriteNotificationWidget extends StatefulWidget {
  ...
  const _FavoriteNotificationWidget(
      {required this.product, required this.isFavorite, required this.onClose});
  @override
